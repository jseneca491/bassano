(function($){
    $(function($, undefined){
        ...
        var targetElement = $('#desktop-header');

        // Set the scroll event handler
        $(window).scroll(function() {
          // Check if the user has scrolled past a certain point (e.g., 200 pixels from the top)
          if ($(this).scrollTop() > 100) {
            // Add the class to the target element
            targetElement.addClass('scrolled');
          } else {
            // Remove the class if the user scrolls back above the specified point
